...
public class SolrUtils {
  ...
  /**
   * Get statistics on a field.
   */
  public static Double getStats(String query, String[]
      filterQuery, String statsField, String stats) {
    try {
      SolrQuery solrQuery = new SolrQuery();
      solrQuery.setQuery(query);
      if (filterQuery != null) {
  ...
  /**
   * Analyze a field and a value against the index phase and return the first value generated by
   * the {@see DEFAULT_FILTER_CLASS}.
   *
   * <p>
   * The field tested MUST use a DEFAULT_FILTER_CLASS in the analyzer chain.
   *
  ...
  /**
   * Analyze a field and a value against the index or query phase and return the first value
   * generated by the specified filterClass.
   *
   * <p>
